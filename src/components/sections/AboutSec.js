...
// Icons
import skillIcon from "../../assets/icons/code-skills-icon.svg";
import sideSkillIcon from "../../assets/icons/side-skills-icon.svg";
// Info
import {
  codeSkills,
  sideSkills,
  aboutInfo,
} from "../../assets/data/textInformation";
// Dependecy
      ...
      <div className="w-full h-full ">
        ...
        <div className="w-full flex items-center">
          <h1 className="sm:text-[4rem] text-[3rem]  font-bold sm:mr-4">
            About <span className="text-ctrgreen">.</span>
          </h1>
          <div
            className="flex-auto h-[1px] sm:block hidden bg-ClBlack-700
          "
          ></div>
        </div>
          ...
          <div className="sm:text-[1.25rem] font-mono flex flex-col flex-auto text-ClBlack-700">
            ...
            <div className="flex items-center secFader">
              ...
              <div className="flex items-center pl-4 gap-4">
                <a href={aboutInfo.aboutLinks.github}>
                  <svg
                    ...
                    height="2.4rem"
                    width="2.4rem"
                    className="hover:fill-ctrgreen fill-ClBlack-700 transition-colors  w-6 h-6"
                  >
                ...
                <a href={aboutInfo.aboutLinks.linkedin}>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    stroke="currentColor"
                    fill="currentColor"
              ...
              <div className="flex flex-wrap gap-4 mt-5">
                {codeSkills.map((item) => {
                  return (
                    <span
                      key={uuidv4()}
                      className="px-2 rounded-full text-lg bg-ClBlack-800"
                    >
                      {item}
                    </span>
                  );
